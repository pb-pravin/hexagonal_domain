...
initializer in the <tt>config/initializers/</tt> directory.
...
is expected to be called outside.

The class also includes <tt>Virtus.model</tt> and
<tt>ActiveModel::Validations</tt> modules to provide corresponding class helpers
...
For example, you can use it in a controller:
    ...
    class YourController < ActionController::Base
      ...
      def your_case
        ...
        use_case.subscribe self # results will be published to the controller
        use_case.subscribe Logger.new # ...and to some logger
...
Here controller doesn't care about business logic, implemented by use cases,
it only calls right case, subscribes listeners and washes its hands.
